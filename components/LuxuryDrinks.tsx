        ...
        <section className="py-16 md:py-24 bg-white">
            <div className="container-custom max-w-5xl">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600">Široká nabídka piv, vín a nápojů</p>
                </div>
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {getDrinkItems(activeTab).map((drink, index) => (
                                    <div
                                        key={drink.id}
                                        className={`drink-item py-5 border-b border-gray-200 last:border-0 hover:bg-gray-50 transition-all duration-300 px-6 -mx-6 rounded-lg ${!isAnimating ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-4"
                                            }`}
                                        style={{
                            ...
                            {activeTab === "Pivo" && (
                                <div className="mt-8 p-6 bg-amber-50 rounded-lg border-2 border-amber-200">
                                    <p className="text-center text-sm text-amber-900">
                                        <span className="font-semibold">Čepované pivo:</span> Pilsner
                                        Urquell a Bernard
                                    </p>
                                </div>
                            )}
                            ...
                            {activeTab === "Nealko" && (
                                <div className="mt-8 p-6 bg-blue-50 rounded-lg border-2 border-blue-200">
                                    <p className="text-center text-sm text-blue-900">
                                        <span className="font-semibold">Specialita:</span> Pravá čepovaná
                                        KOFOLA
                                    </p>
                                </div>
                            )}
