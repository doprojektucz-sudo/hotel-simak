...
// components/chata-milunda/ChataMilundaClient.tsx
// Veškerý původní obsah chata-milunda/page.tsx patří sem
...
export default function ChataMilundaClient() {
    return (
        <>
            <main>
                <Hero
                    ...
                    primaryCta={{ text: "Rezervovat chatu", href: "#booking" }}
                />
                                    ...
                                    <div className="flex items-start justify-between gap-4">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-500 mt-1">{chataMilunda.location}</p>
                                            </div>
                                        </div>
                ...
                <section className="py-24 bg-gray-900 relative overflow-hidden">
                    ...
                    <div className="container-custom relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { icon: UtensilsCrossed, title: "Kuchyň", desc: "Lednice a mikrovlnná trouba pro přípravu jídel", from: "from-primary-500", to: "to-primary-700" },
                                { icon: Bed, title: "Ložnice", desc: "2 ložnice pro pohodlný spánek", from: "from-secondary-500", to: "to-secondary-700" },
                                { icon: Bath, title: "Sociální zařízení", desc: "Koupelna a suchý záchod", from: "from-primary-600", to: "to-secondary-600" },
                                { icon: Flame, title: "Ohniště", desc: "Venkovní ohniště pro grilovací večery", from: "from-secondary-600", to: "to-primary-600" },
                            ].map(({ icon: Icon, title, desc, from, to }) => (
                                <div key={title} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-all group text-center">
                                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${from} ${to} flex items-center justify-center mx-auto mb-5 group-hover:scale-110 transition-transform shadow-lg`}>
                ...
                <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
                    <div className="container-custom">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { icon: Fish, title: "Rybaření", desc: "Rybaření přímo u chaty na vodní nádrži Strž", bg: "bg-primary-50", from: "from-primary-500", to: "to-primary-700", hover: "from-primary-500 to-primary-700" },
                                { icon: Waves, title: "Loďka zdarma", desc: "Zapůjčení loďky pro projížďky po nádrži zdarma", bg: "bg-secondary-50", from: "from-secondary-500", to: "to-secondary-700", hover: "from-secondary-500 to-secondary-700" },
                                { icon: Bike, title: "Cykloturistika", desc: "Krásné cyklotrasy v okolí pro všechny úrovně", bg: "bg-primary-50", from: "from-primary-600", to: "to-secondary-600", hover: "from-primary-600 to-secondary-600" },
                                { icon: TreePine, title: "Houbaření", desc: "Bohaté lesy plné hub v okolí chaty", bg: "bg-secondary-50", from: "from-secondary-600", to: "to-primary-600", hover: "from-secondary-600 to-primary-600" },
                            ].map(({ icon: Icon, title, desc, bg, from, to, hover }) => (
                                <div key={title} className={`group ${bg} rounded-3xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden`}>
                                    ...
                                    <div className="relative z-10">
                                        <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${from} ${to} flex items-center justify-center mb-5 group-hover:scale-110 transition-transform shadow-lg`}>
                                            <Icon className="w-8 h-8 text-white" />
                                        </div>
                                        <h3 className="text-xl font-bold text-gray-900 group-hover:text-white mb-2 transition-colors">{title}</h3>
                                        <p className="text-gray-600 group-hover:text-white/90 transition-colors">{desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                {/* Booking CTA */}
                <section id="booking" className="py-24 bg-gradient-to-br from-secondary-600 via-secondary-700 to-secondary-800 relative overflow-hidden">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <div className="text-center mb-12">
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-secondary-100">
                                    ...
                                    <span>Kapacita {chataMilunda.capacity.beds} osob + {chataMilunda.capacity.extraBeds} přistýlky</span>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                                ...
                                >
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Zavolejte nám</p>
                                            <p className="text-2xl font-bold text-gray-900">728 490 498</p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Napište nám</p>
                                            <p className="text-xl font-bold text-gray-900">Kontaktní formulář</p>
                                        </div>
                                    </div>
